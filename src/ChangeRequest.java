...
public abstract class ChangeRequest {
    ...
    public void addChangeListener(IChangeListener listener) {
        if (_localListeners == null) {
            _localListeners = new LinkedList<IChangeListener>();
        }
    ...
    public final synchronized void execute() {
        ...
        if (_localListeners != null) {
            ...
            for (IChangeListener listener : _localListeners) {
                if (_exception == null) {
        ...
        if (_listeners != null) {
            ...
            while (listeners.hasNext()) {
                ...
                if (listener instanceof IChangeListener) {
                    if (_exception == null) {
                        ((IChangeListener) listener).changeExecuted(this);
                    } else {
                        needToReport = false;
                        ((IChangeListener) listener).changeFailed(this,
                                _exception);
                    }
                }
            }
        ...
        try {
            if (needToReport) {
                if (_exception != null) {
                  ...
                  //  ptolemy.kernel.util.Nameable object = null;

                  //  if (_source instanceof ptolemy.kernel.util.Nameable) {
                  //      object = (ptolemy.kernel.util.Nameable) _source;
                  //  }
